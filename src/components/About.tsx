    ...
    return (
        <section id="about" className="w-full relative flex flex-col md:flex-row justify-between gap-16 py-32 px-6 md:px-12 lg:px-24 border-t border-foreground/10">
            ...
            <div className="w-full md:w-1/2 flex flex-col z-10">
                ...
                <div className="flex flex-col gap-12 text-foreground/80 text-lg md:text-xl lg:text-2xl leading-relaxed font-medium">
            ...
            <div className="w-full md:w-1/2 flex flex-col md:items-end justify-start pt-12 md:pt-48 z-10">
                <div className="flex flex-col text-left md:text-right max-w-md">
                    ...
                    <div className="flex flex-col gap-2">
                        <span className="text-2xl md:text-3xl font-bold text-foreground">B.Tech Computer Science</span>
                        <span className="text-xl text-foreground/80">Manipal University Jaipur</span>
                        <span className="text-base text-[#7B5944] font-bold mt-2 tracking-widest uppercase">GPA: 8.5</span>
                    </div>
