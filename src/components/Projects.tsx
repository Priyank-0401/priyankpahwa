    ...
    return (
        <section id="projects" className="w-full relative flex flex-col py-32 px-6 md:px-12 lg:px-24">
            ...
            <div className="absolute top-32 right-0 w-full overflow-hidden flex justify-end pointer-events-none z-0 select-none opacity-[0.015]">
                <span
                    className="text-[22vw] leading-none text-foreground whitespace-nowrap"
                ...
                <div className="flex flex-col gap-40 md:gap-48">
                    ...
                    <article className="relative flex flex-col lg:flex-row gap-8 lg:gap-16 group">
                        ...
                        <div className="w-full lg:w-1/3 flex flex-col z-10">
                            <h3
                                className="text-5xl md:text-6xl lg:text-7xl font-bold text-foreground uppercase tracking-[0.05em] leading-none mb-4 opacity-90 group-hover:translate-x-2 transition-transform duration-300 w-fit"
                                style={{ fontFamily: 'var(--font-anton)' }}
                            >
                                Seriva
                            </h3>
                            ...
                            <a href="https://github.com/Priyank-0401/Seriva-Showcase" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border-2 border-foreground items-center justify-center hover:bg-foreground hover:text-background transition-colors mt-auto hidden lg:flex">
                                ↗
                            </a>
                        </div>
                        <div className="w-full lg:w-2/3 flex flex-col border-t-4 border-foreground pt-8 z-10 lg:ml-8 -rotate-1 group-hover:rotate-0 transition-transform duration-500">
                    ...
                    <article className="relative flex flex-col lg:flex-row-reverse gap-8 lg:gap-16 group">
                        ...
                        <div className="w-full lg:w-1/3 flex flex-col z-10 items-start lg:items-end text-left lg:text-right">
                            <h3
                                className="text-5xl md:text-6xl lg:text-7xl font-bold text-foreground uppercase tracking-[0.05em] leading-none mb-4 opacity-90 group-hover:-translate-x-2 transition-transform duration-300 w-fit"
                                style={{ fontFamily: 'var(--font-anton)' }}
                            >
                            ...
                            <a href="https://github.com/Priyank-0401/Inventory-Management" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border-2 border-foreground items-center justify-center hover:bg-foreground hover:text-background transition-colors mt-auto hidden lg:flex">
                                ↗
                            </a>
                        </div>
                        <div className="w-full lg:w-2/3 flex flex-col border-t-4 border-foreground pt-8 z-10 lg:mr-8 rotate-1 group-hover:rotate-0 transition-transform duration-500">
                            <p className="text-2xl md:text-3xl font-medium text-foreground/90 max-w-2xl leading-tight mb-8">
                    ...
                    <article className="relative flex flex-col lg:flex-row gap-8 lg:gap-16 group">
                        ...
                        <div className="w-full lg:w-1/3 flex flex-col z-10">
                            ...
                            <a href="https://github.com/Priyank-0401/wepay-crypto" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border-2 border-foreground items-center justify-center hover:bg-foreground hover:text-background transition-colors mt-auto hidden lg:flex">
                                ↗
                            </a>
                        </div>
                        <div className="w-full lg:w-2/3 flex flex-col border-t-4 border-foreground pt-8 z-10 lg:ml-8 -rotate-1 group-hover:rotate-0 transition-transform duration-500">
